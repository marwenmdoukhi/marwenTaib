!(function (t, e) {
    ...
    function Kt(t, e, i) {
        ...
        return (
            ...
            "" !== (n = o ? n.replace(Zt, "$1") : n) || k(t) || (n = T.style(t, e)),
            !g.pixelBoxStyles() && Yt.test(n) && Gt.test(e) && ((o = s.width), (t = s.minWidth), (e = s.maxWidth), (s.minWidth = s.maxWidth = s.width = n), (n = i.width), (s.width = o), (s.minWidth = t), (s.maxWidth = e))),
                void 0 !== n ? n + "" : n
        );
    }
    function Jt(t, e) {
    ...
    function se(t) {
        return (
            ...
            (t in ne
                ...
                : (oe[t] =
                    (function (t) {
                        for (var e = t[0].toUpperCase() + t.slice(1), i = ie.length; i--; ) if ((t = ie[i] + e) in ne) return t;
                    })(t) || t))
        );
    }
    ...
    T.extend({
        ...
        T.each(["height", "width"], function (t, r) {
            T.cssHooks[r] = {
                get: function (t, e, i) {
                    if (e)
                        return !re.test(T.css(t, "display")) || (t.getClientRects().length && t.getBoundingClientRect().width)
                            ? he(t, r, i)
                            : Ft(t, ae, function () {
                                return he(t, r, i);
                            });
                ...
                set: function (t, e, i) {
                    var n = qt(t),
                        ...
                        i = i ? ue(t, r, i, s, n) : 0;
                    return (
                        s && o && (i -= Math.ceil(t["offset" + r[0].toUpperCase() + r.slice(1)] - parseFloat(n[r]) - ue(t, r, "border", !1, n) - 0.5)),
    ...
    (T.Animation = T.extend(D, {
        ...
        T.each({ slideDown: ve("show"), slideUp: ve("hide"), slideToggle: ve("toggle"), fadeIn: { opacity: "show" }, fadeOut: { opacity: "hide" }, fadeToggle: { opacity: "toggle" } }, function (t, n) {
                    ...
                    attr: function (t, e, i) {
                        ...
                        if (3 !== s && 8 !== s && 2 !== s)
                            return void 0 === t.getAttribute
                                ? T.prop(t, e, i)
                                : ((1 === s && T.isXMLDoc(t)) || (o = T.attrHooks[e.toLowerCase()] || (T.expr.match.bool.test(e) ? be : void 0)),
                                    void 0 !== i
                                        ? null === i
                ...
                return y(e)
                    ...
                    : arguments.length
                        ? (t = Ce(e)).length
                            ? this.each(function () {
                                if (((n = j(this)), (i = 1 === this.nodeType && " " + M(n) + " "))) {
                                    for (s = 0; s < t.length; s++) for (o = t[s]; -1 < i.indexOf(" " + o + " "); ) i = i.replace(" " + o + " ", " ");
                                    (r = M(i)), n !== r && this.setAttribute("class", r);
                                }
                            })
                            : this
            ...
            toggleClass: function (e, i) {
                ...
                return y(e)
                    ...
                    : "boolean" == typeof i && a
                        ...
                        : ((t = Ce(e)),
                            this.each(function () {
                                if (a) for (s = T(this), o = 0; o < t.length; o++) (n = t[o]), s.hasClass(n) ? s.removeClass(n) : s.addClass(n);
    ...
    (Be.href = Ae.href),
        T.extend({
            ...
            ajax: function (t, e) {
                ...
                var l,
                    ...
                    _ = {
                        ...
                        getResponseHeader: function (t) {
                            var e;
                            if (d) {
                                if (!i) for (i = {}; (e = Ne.exec(u)); ) i[e[1].toLowerCase() + " "] = (i[e[1].toLowerCase() + " "] || []).concat(e[2]);
                                e = i[t.toLowerCase() + " "];
                            }
                ...
                if (
                    (v.promise(_),
                        (f.url = ((t || f.url || Ae.href) + "").replace(qe, Ae.protocol + "//")),
                ...
                if ((f.data && f.processData && "string" != typeof f.data && (f.data = T.param(f.data, f.traditional)), Ve(Fe, f, e, _), !d)) {
                    for (n in ((p = T.event && f.global) && 0 == T.active++ && T.event.trigger("ajaxStart"),
                        ...
                        f.hasContent
                            ...
                            f.data && (f.processData || "string" == typeof f.data) && ((c += (Ie.test(c) ? "&" : "?") + f.data), delete f.data),
                            !1 === f.cache && ((c = c.replace(Pe, "$1")), (o = (Ie.test(c) ? "&" : "?") + "_=" + Se.guid++ + o)),
                                (f.url = c + o)),
                                ...
                                ((s = r = n.onload = n.onerror = n.onabort = n.ontimeout = n.onreadystatechange = null),
                                    "abort" === t
                                        ...
                                        : "error" === t
                                            ...
                                            : e(Qe[n.status] || n.status, n.statusText, "text" !== (n.responseType || "text") || "string" != typeof n.responseText ? { binary: n.response } : { text: n.responseText }, n.getAllResponseHeaders()));
                            };
                        }),
                            (n.onload = s()),
    ...
    var Xe = [],
        ...
        Ze =
            (T.ajaxSetup({
                ...
                (g.createHTMLDocument = (((s = C.implementation.createHTMLDocument("").body).innerHTML = "<form></form><form></form>"), 2 === s.childNodes.length)),
    ...
    (function (t, e) {
        ...
        function T(t, e, i) {
            ...
            var n = t.getBoundingClientRect(),
                ...
                e = n.width / o,
                o = n.height / s;
            return { width: e, height: o, top: t, right: i + e, bottom: t + o, left: i, x: i, y: t };
        }
        function Jt(t) {
            var e = T(t),
                i = t.offsetWidth,
        ...
        function ne(t) {
            ...
            return (
                ((!n || ("html" !== v(n) && ("body" !== v(n) || "static" !== E(n).position))) &&
                    (n ||
                        (function (t) {
        ...
        var le = {
            ...
            fn: function (t) {
                ...
                a &&
                l &&
                ((t = re("number" != typeof (t = "function" == typeof (t = t.padding) ? t(Object.assign({}, s.rects, { placement: s.placement })) : t) ? t : ae(t, O))),
                    (e = Jt(a)),
                    (o = "y" === u ? A : L),
                    (n = "y" === u ? S : I),
        ...
        function he(t) {
            ...
            ((y = "clientHeight"),
                (e = "clientWidth"),
            (v = ne(i)) === _(i) && "static" !== E((v = M(i))).position && "absolute" === a && ((y = "scrollHeight"), (e = "scrollWidth")),
            ...
            var v,
                ...
                t = !0 === u ? ((o = (y = { x: h, y: d }).y), (s = window.devicePixelRatio || 1), { x: C(y.x * s) / s || 0, y: C(o * s) / s || 0 }) : { x: h, y: d };
            return (
                (h = t.x),
                    (d = t.y),
                    l
        ...
        var de = {
                ...
                fn: function (t) {
                    var e = t.state,
                        ...
                        t = t.roundOffsets,
                        t = void 0 === t || t,
                        i = { placement: D(e.placement), variation: ce(e.placement), popper: e.elements.popper, popperRect: e.rects.popper, gpuAcceleration: i, isFixed: "fixed" === e.options.strategy };
                    null != e.modifiersData.popperOffsets &&
                    (e.styles.popper = Object.assign({}, e.styles.popper, he(Object.assign({}, i, { offsets: e.modifiersData.popperOffsets, position: e.options.strategy, adaptive: n, roundOffsets: t })))),
                    null != e.modifiersData.arrow && (e.styles.arrow = Object.assign({}, e.styles.arrow, he(Object.assign({}, i, { offsets: e.modifiersData.arrow, position: "absolute", adaptive: !1, roundOffsets: t })))),
            ...
            return e === Nt
                ? Ce(
                    ((o = i),
                        ...
                        (a = a.clientHeight),
                        (u = c = 0),
                    r && ((l = r.width), (a = r.height), ((s = Kt()) || (!s && "fixed" === o)) && ((c = r.offsetLeft), (u = r.offsetTop))),
        ...
        function ke(t, e) {
            var i,
                ...
                c =
                    ((i = w(p) ? p : p.contextElement || M(t.elements.popper)),
                        ...
                        (s =
                            "clippingParents" === (h = u)
                                ? ((r = xe(ee((s = i)))),
                                    w((o = 0 <= ["absolute", "fixed"].indexOf(E(s).position) && x(s) ? ne(s) : s))
                                        ? r.filter(function (t) {
                ...
                h = Ee({ reference: u, element: f, strategy: "absolute", placement: l }),
                p = Ce(Object.assign({}, f, h)),
                f = d === g ? p : u,
                m = { top: c.top - f.top + e.top, bottom: f.bottom - c.bottom + e.bottom, left: c.left - f.left + e.left, right: f.right - c.right + e.right },
                ...
                if (!h.modifiersData[t]._skip) {
                    for (
                                    ...
                                    D(e) === jt
                                        ? ((i = h),
                                            ...
                                            (u = (n =
                                                ...
                                                return (t[e] = ke(i, { placement: e, boundary: o, rootBoundary: s, padding: r })[D(e)]), t;
                                            }, {})),
                        ...
                        var _ = a[b],
                            ...
                            C = 0 <= [A, S].indexOf(w),
                            T = C ? "width" : "height",
                            E = ke(h, { placement: _, boundary: p, rootBoundary: f, altBoundary: s, padding: d }),
                            C = C ? (x ? I : L) : x ? S : A,
        ...
        var Le = {
            ...
            ze = {
                ...
                fn: function (t) {
                    var e = t.state,
                        t = t.name;
                    e.modifiersData[t] = Ee({ reference: e.rects.reference, element: e.rects.popper, strategy: "absolute", placement: e.placement });
                },
                data: {},
            },
            De = {
                ...
                fn: function (t) {
                    var e,
                        ...
                        h = h.tetherOffset,
                        h = void 0 === h ? 0 : h,
                        f = ke(u, { boundary: f, rootBoundary: m, padding: v, altBoundary: g }),
                        m = D(u.placement),
                        v = ce(u.placement),
                        g = !v,
                        b = oe(m),
                    ...
                    ((n = "y" == _ ? "height" : "width"),
                        ...
                        (a = y && s ? ((c = se(r, i, (l = v))), l < c ? l : c) : se(y ? r : o, i, y ? v : d)),
                        (w[_] = a),
                        (E[_] = a - i)),
                        (u.modifiersData[t] = E));
                },
        ...
        function Ne(t) {
            ...
            return function (n, o, e) {
                ...
                var i,
                    s,
                    p = { placement: "bottom", orderedModifiers: [], options: Object.assign({}, je, c), modifiersData: {}, elements: { reference: n, popper: o }, attributes: {}, styles: {} },
                    r = [],
                    f = !1,
                    m = {
                        state: p,
                        setOptions: function (t) {
                            ...
                            a(), (p.options = Object.assign({}, c, p.options, t)), (p.scrollParents = { reference: w(n) ? xe(n) : n.contextElement ? xe(n.contextElement) : [], popper: xe(o) });
                                    ...
                                    (p.rects = {
                                        reference:
                                            ...
                                            void 0 === (a = "fixed" === p.options.strategy) && (a = !1),
                                                (l = x(r)),
                                                (c = x(r) && ((h = (c = r).getBoundingClientRect()), (u = C(h.width) / c.offsetWidth || 1), (h = C(h.height) / c.offsetHeight || 1), 1 !== u || 1 !== h)),
                                                (u = M(r)),
                                                (h = T(e, c, a)),
                                                (e = { scrollLeft: 0, scrollTop: 0 }),
                                                (d = { x: 0, y: 0 }),
                                            (!l && a) ||
                                            (("body" === v(r) && !we(u)) || (e = (l = r) !== _(l) && x(l) ? { scrollLeft: l.scrollLeft, scrollTop: l.scrollTop } : be(l)),
                                                x(r) ? (((d = T(r, !0)).x += r.clientLeft), (d.y += r.clientTop)) : u && (d.x = _e(u))),
        ...
        var Re = Ne(),
            ...
            Fe = Ne({ defaultModifiers: [fe, ze, de, Xt, Oe, Ae, De, le, Le] });
        ...
        const ai = "mousedown.bs.backdrop",
            ...
            ci = { className: "string", clickCallback: "(function|null)", isAnimated: "boolean", isVisible: "boolean", rootElement: "(element|string)" };
        class ui extends ht {
            constructor(t) {
        ...
        const gi = "hidden.bs.modal",
            ...
            wi = { backdrop: "(boolean|string)", focus: "boolean", keyboard: "boolean" };
        class xi extends e {
            constructor(t, e) {
                super(t, e),
            ...
            show(t) {
                ...
                ((this._isShown = !0), (this._isTransitioning = !0), this._scrollBar.hide(), document.body.classList.add(yi), this._adjustDialog(), this._backdrop.show(() => this._showElement(t)));
            }
            hide() {
                !this._isShown ||
                this._isTransitioning ||
        ...
        const Ci = "showing",
            ...
            Ai = { backdrop: !0, keyboard: !0, scroll: !1 },
            Si = { backdrop: "(boolean|string)", keyboard: "boolean", scroll: "boolean" };
        class j extends e {
            constructor(t, e) {
        ...
        const Ii = new Set(["background", "cite", "href", "itemtype", "longdesc", "poster", "src", "xlink:href"]),
            ...
            Di = { allowList: zi, content: {}, extraClass: "", html: !1, sanitize: !0, sanitizeFn: null, template: "<div></div>" },
            Mi = { allowList: "object", content: "object", extraClass: "(string|function)", html: "boolean", sanitize: "boolean", sanitizeFn: "(null|function)", template: "string" },
        ...
        class Pi extends ht {
            ...
            _checkContent(t) {
                for (var [e, i] of Object.entries(t)) super._typeCheckConfig({ selector: e, entry: i }, ji);
            }
            _setContent(t, e, i) {
        ...
        const Ni = new Set(["sanitize", "allowList", "sanitizeFn"]),
            ...
            Fi = "hide.bs.modal",
            Hi = "hover",
            Wi = { AUTO: "auto", TOP: "top", RIGHT: l() ? "left" : "right", BOTTOM: "bottom", LEFT: l() ? "right" : "left" },
            Bi = {
                allowList: zi,
                animation: !0,
        ...
        class Vi extends e {
            ...
            hide() {
                if (this._isShown() && !y.trigger(this._element, this.constructor.eventName("hide")).defaultPrevented) {
                    ...
                    if ((t.classList.remove(qi), "ontouchstart" in document.documentElement)) for (const t of [].concat(...document.body.children)) y.off(t, "mouseover", H);
            ...
            _getTemplateFactory(t) {
                return (
                    this._templateFactory ? this._templateFactory.changeContent(t) : (this._templateFactory = new Pi({ ...this._config, content: t, extraClass: this._resolvePossibleFunction(this._config.customClass) })),
        ...
        const Xi = "click.bs.scrollspy",
            Gi = "active",
            Zi = { offset: null, rootMargin: "0px 0px -25%", smoothScroll: !1, target: null, threshold: [0.1, 0.5, 1] },
        ...
        class Ji extends e {
            ...
            _process(t) {
                this._activeTarget !== t && (this._clearActiveClass(this._config.target), (this._activeTarget = t).classList.add(Gi), this._activateParents(t), y.trigger(this._element, "activate.bs.scrollspy", { relatedTarget: t }));
            }
            _activateParents(t) {
                if (t.classList.contains("dropdown-item")) d.findOne(".dropdown-toggle", t.closest(".dropdown")).classList.add(Gi);
                else for (const e of d.parents(t, ".nav, .list-group")) for (const t of d.prev(e, ".nav-link, .nav-item > .nav-link, .list-group-item")) t.classList.add(Gi);
            }
            _clearActiveClass(t) {
        ...
        class an extends e {
            ...
            _activate(t, e) {
                ...
                (t.classList.add(nn),
                    ...
                    this._queueCallback(
                        () => {
                            "tab" === t.getAttribute("role") ? (t.removeAttribute("tabindex"), t.setAttribute("aria-selected", !0), this._toggleDropDown(t, !0), y.trigger(t, "shown.bs.tab", { relatedTarget: e })) : t.classList.add(on);
                        },
                        t,
        ...
        return dt(dn), t(dn), { Alert: pt, Button: mt, Carousel: At, Collapse: Mt, Dropdown: m, Modal: xi, Offcanvas: j, Popover: Yi, ScrollSpy: Ji, Tab: an, Toast: dn, Tooltip: Vi };
    }),
    (function (t) {
    ...
    jQuery(document).ready(function (r) {
        ...
        function f(t) {
            ...
            t.parents(".word-rotator").hasClass("type")
                ? ((e = t.parent(".²")).addClass("selected").removeClass("waiting"),
                    setTimeout(function () {
