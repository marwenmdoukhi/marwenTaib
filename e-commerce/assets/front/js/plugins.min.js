        ...
        (g.prototype = {
            ...
            open: function (i) {
                ...
                if (!e.isOpen) {
                    ...
                    e.st.preloader && (e.preloader = z("preloader", e.container, e.st.tLoading));
                ...
                getImage: function (i, o) {
                    ...
                    return (
                        e._parseMarkup(o, { title: E(i), img_replaceWith: i.img }, i),
                            e.resizeImage(),
                            i.hasSize
                                ? (O && clearInterval(O), i.loadError ? (o.addClass("mfp-loading"), e.updateStatus("error", a.tError.replace("%url%", i.src))) : (o.removeClass("mfp-loading"), e.updateStatus("ready")), o)
            ...
            t.magnificPopup.registerModule("zoom", {
                ...
                proto: {
                    ...
                    _getOffset: function (i) {
                        ...
                        return (
                            void 0 === P && (P = void 0 !== document.createElement("p").style.MozTransform), P ? (a["-moz-transform"] = a.transform = "translate(" + s.left + "px," + s.top + "px)") : ((a.left = s.left), (a.top = s.top)), a
                        );
                    },
                },
            });
        ...
        (s.Defaults = {
            ...
            (s.prototype.to = function (t, e) {
                var i = this.current(),
                    ...
                    h = this.maximum();
                this.settings.loop
                    ? (!this.settings.rewind && Math.abs(s) > r / 2 && (s += -1 * n * r), (o = (((((t = i + s) - a) % r) + r) % r) + a) !== t && o - s <= h && o - s > 0 && ((i = o - s), (t = o), this.reset(i)))
        ...
        (s.Defaults = { video: !1, videoHeight: !1, videoWidth: !1 }),
            (s.prototype.fetch = function (t, e) {
                var i = t.attr("data-vimeo-id") ? "vimeo" : t.attr("data-vzaar-id") ? "vzaar" : "youtube",
                    ...
                    r = t.attr("href");
                if (!r) throw new Error("Missing video Verif.");
                if (
                    (o = r.match(
                    ...
                    if (!(o[3].indexOf("vzaar") > -1)) throw new Error("Video Verif not supported.");
                    i = "vzaar";
                }
            ...
            (s.prototype.thumbnail = function (e, i) {
                var o,
                    ...
                    p = function (i) {
                        (o = l.lazyLoad ? t("<div/>", { class: "owl-video-tn " + h, srcType: i }) : t("<div/>", { class: "owl-video-tn", style: "opacity:1;background-image:url(" + i + ")" })),
                            e.after(o),
                            e.after('<div class="owl-video-play-icon"></div>');
                    };
                if ((e.wrap(t("<div/>", { class: "owl-video-wrapper", style: n })), this._core.settings.lazyLoad && ((a = "data-src"), (h = "owl-lazy")), r.length)) return p(r.attr(a)), r.remove(), !1;
                "youtube" === i.type
    ...
    (function (t, e, i, o) {
        ...
        (s.Defaults = {
            ...
            (s.prototype.initialize = function () {
                ...
                i.dotsData || (this._templates = [t('<button role="button" title="dot">').addClass(i.dotClass).append(t("<span>")).prop("outerHTML")]),
    ...
    (function (t, e, i, o) {
        ...
        !!s("transition") && ((t.support.transition = new String(n("transition"))), (t.support.transition.end = h.transition.end[t.support.transition])),
        !!s("animation") && ((t.support.animation = new String(n("animation"))), (t.support.animation.end = h.animation.end[t.support.animation])),
        s("transform") && ((t.support.transform = new String(n("transform"))), (t.support.transform3d = !!s("perspective")));
    })(window.Zepto || window.jQuery, window, document),
    (function (t, e) {
        "use strict";
        var i,
                ...
                ((i = "sf-breadcrumb"),
                    ...
                    (f = function (e) {
                        ...
                        return !1 === o.onHandleTouch.call(s)
                            ? this
                            : void (s.length > 0 && s.is(":hidden") && (i.one("click.superfish", !1), "MSPointerDown" === e.type || "pointerdown" === e.type ? i.trigger("focus") : t.proxy(d, i.parent("li"))()));
                    }),
                    (g = function (e, i) {
        ...
        var s = {
            ...
            fetch: function (t) {
                var e = this,
                    i = new Image();
                (i.onload = function () {
                    (e.largeWidth = i.width), (e.largeHeight = i.height), (e.currentImage = e.imageSrc), e.options.onZoomedImageLoaded(e.$elem);
                }),
                    (i.src = t);
            },
        ...
        (r.prototype.transformSupport = function (t) {
                ...
                case "3D":
                    if (s) {
                        var c = i.body || i.createElement("body"),
                            ...
                            u = d.style.overflow,
                            m = !1;
                        i.body || ((m = !0), (d.style.overflow = "hidden"), d.appendChild(c), (c.style.overflow = "hidden"), (c.style.background = "")),
                            c.appendChild(o),
                            (o.style[h] = "translate3d(1px,1px,1px)"),
                            (r = void 0 !== (n = e.getComputedStyle(o).getPropertyValue(a)) && n.length > 0 && "none" !== n),
                            (d.style.overflow = u),
                            c.removeChild(o),
            ...
            (r.prototype.onMouseMove = function (t) {
                ...
                !this.orientationSupport && this.relativeInput
                    ? (this.clipRelativeInput && ((e = Math.max(e, this.ex)), (e = Math.min(e, this.ex + this.ew)), (i = Math.max(i, this.ey)), (i = Math.min(i, this.ey + this.eh))),
            ...
            (i.prototype = {
                ...
                movement: function (t) {
                    ...
                    (this.options.horizontal
                        ? i.css({ transform: "translate3d(" + t + n / this.options.speed + "%, " + t + n / this.options.speed + "%, 0)" })
                        : i.css({ transform: "translate3d(0, " + t + n / this.options.speed + "%, 0)" }));
                },
            }),
