...
import {OrdersViewModelMaster} from "../../order/view-models/bases/OrdersViewModelMaster";
...
@Component({
    ...
    styleUrls: ['../../contact/components/ListContactComponent.css'],
...
export class AllResultComponent implements OnInit {
    ...
    ngOnInit(): void {
        ...
        console.log(this.displayAllResult);
    }
    ...
    text2(): string {
        ...
        return decodeURIComponent('Voir tous les résultats pour «'+ this.inputReasearchBar+'»');
    }
