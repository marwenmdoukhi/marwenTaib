...
import { DashboardCounselComponent } from './components/DashboardCounselComponent';
...
@NgModule({
    imports: [SignaturePadModule, HttpClientModule, RadioButtonModule, DialogModule, CodeHighlighterModule, TabViewModule, ToastModule, BrowserAnimationsModule, MenuModule, StepsModule,
        ...
        FileUploadModule, ReactiveFormsModule, HttpModule, CalendarModule, FormsModule, TableModule, CheckboxModule, PaginatorModule, TabMenuModule, ToastrModule.forRoot(), CommonModule, BrowserModule, FormsModule, ReactiveFormsModule, HttpModule, BrowserAnimationsModule, ToastrModule.forRoot(), InlineSVGModule,InternationalPhoneNumberModule.forRoot()

    ],
    declarations: [DashboardCounselComponent,BarPipe,AllResultComponent,HighlightSearch],
    ...
    bootstrap: [DashboardCounselComponent]
})
export class DashboardCounselcomponentModule { }